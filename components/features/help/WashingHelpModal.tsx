...
interface WashingHelpModalProps {
  isVisible: boolean;
  onClose: () => void;
}

export const WashingHelpModal: React.FC<WashingHelpModalProps> = ({
  isVisible,
  onClose,
}) => {
  const content = (
    <>
      <Text className="text-base font-dm-light text-enaleia-black mb-2">
        This attestation is used when washing waste collections.
      </Text>
      ...
      <View>
        ...
        <View className="gap-0">
          ...
          <View className="flex-row">
            <Text className="text-base font-dm-light text-enaleia-black w-4">3.</Text>
            <Text className="text-base font-dm-light text-enaleia-black flex-1">
              <Text className="font-dm-bold">Put a new QR</Text> code sticker on the washed material
            </Text>
          </View>
          <View className="flex-row">
            <Text className="text-base font-dm-light text-enaleia-black w-4">4.</Text>
          ...
          <View className="flex-row">
            ...
            <Text className="text-base font-dm-light text-enaleia-black flex-1">
              <Text className="font-dm-bold">Repeat</Text> for each outgoing washed materials, if applicable
            </Text>
          </View>
        </View>
      </View>
      ...
      categories={[
        {
          name: "Washing",
          icon: <Image 
            source={require('../../../assets/images/action-icons/Washing.webp')}
